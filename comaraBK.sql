...
COPY public."ARTICULOS" ("artCod", "artDesc", activo, "artStock", "artUni", "artStockMin", "artExist", "rubCod", "srubCod", "marCod", "ivaCod", "artAlt1", "artAlt2", "artL1", "artL2", "artL3", "artL4", "artL5", coef1, coef2, coef3, "artDestino", iva, imp_interno, "artTalonario", "artCbteNro", "FechCom", "FechMod", "FechVto", "artDesc2", "Foto", exento, conjunto) FROM stdin;
\.
...
SELECT pg_catalog.setval('public."MARCAS_marCod_seq"', 1, false);
...
SELECT pg_catalog.setval('public."PROVEEDORES_proCod_seq"', 1, false);
